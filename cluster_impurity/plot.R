...
plot(
	...
	t='n',
	main="Median and Standard Deviation of Cluster Impurities",
	sub="Median and standard deviation are calculated over all clusters' impurities of all runs for each timestep",
	xlab="Timestep",
...
plot(
	...
	main="Density (Distribution) of Cluster Impurities for Different Timesteps",
	sub=sprintf(
		"Density is drawn for every %sth timestep, cluster impurities are aggregated over all clusters' impurities of all runs for each timestep",
		density.interval
	),
	xlab="Cluster Impurity",
	ylab="Density"
)
