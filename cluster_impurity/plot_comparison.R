library(data.table)
d0.1 = fread("cluster_impurity.out.500.20.0.1.tsv")
d0.3 = fread("cluster_impurity.out.500.20.0.3.tsv")
d0.5 = fread("cluster_impurity.out.500.20.0.5.tsv")
d0.7 = fread("cluster_impurity.out.500.20.0.7.tsv")
d0.9 = fread("cluster_impurity.out.500.20.0.9.tsv")
...
plot(
	...
	t='n',
	main="Comparison of Median of Cluster Impurity",
	sub="Median is calculated over all clusters' impurities of all runs for each timestep",
	xlab="Timestep",
...
plot(
	...
	t='n',
	main="Comparison of Mean of Cluster Impurity",
	sub="Mean is calculated over all clusters' impurities of all runs for each timestep",
	xlab="Timestep",
	ylab="Cluster Impurity"
)
...
plot(
	...
	t='n',
	main="Comparison of Standard Deviation of Cluster Impurity",
	sub="Standard deviation is calculated over all clusters' impurities of all runs for each timestep",
	xlab="Timestep",
	ylab="Cluster Impurity"
