library(data.table)
d0.1 = fread("interedges_forest.out.500.20.0.1.tsv")
d0.3 = fread("interedges_forest.out.500.20.0.3.tsv")
d0.5 = fread("interedges_forest.out.500.20.0.5.tsv")
d0.7 = fread("interedges_forest.out.500.20.0.7.tsv")
d0.9 = fread("interedges_forest.out.500.20.0.9.tsv")
...
plot(
	...
	t='n',
	main="Comparison of Median of Fraction of Interedges in the Forest",
...
plot(
	...
	t='n',
	main="Comparison of Mean of Fraction of Interedges in the Forest",
...
plot(
	...
	t='n',
	main="Comparison of Standard Deviation of Fraction of Interedges in the Forest",
