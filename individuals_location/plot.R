...
title(
	main="Boxplots of Fraction of Individuals in their Home Subcluster",
	sub="Timesteps are divided into 50 intervals, for each interval all values of fraction of Individuals are aggregated in one boxplot",
	xlab="Timestep",
...
plot(
	...
	t='n',
	main="Mean, Median and Standard Deviation of Fraction of Individuals in their Home Subcluster",
	sub="Median, median and standard deviation are calculated over all runs for each timestep",
	xlab="Timestep",
	ylab="Mean, Median (Fraction of Individuals)"
)
...
axis(side=4)
mtext(side=4, line=3, 'Standard Deviation (Fraction of Individuals)')
