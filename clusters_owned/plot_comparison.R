library(data.table)
d0.1 = fread("clusters_owned.out.500.20.0.1.tsv")
d0.3 = fread("clusters_owned.out.500.20.0.3.tsv")
d0.5 = fread("clusters_owned.out.500.20.0.5.tsv")
d0.7 = fread("clusters_owned.out.500.20.0.7.tsv")
d0.9 = fread("clusters_owned.out.500.20.0.9.tsv")
...
plot(
	...
	t='n',
	main="Comparison of Median of Fraction of Clusters Owned",
	sub="Median is calculated over the fraction of clusters owned of all runs for each timestep",
	xlab="Timestep",
	ylab="Fraction of Clusters Owned"
)
...
plot(
	...
	t='n',
	main="Comparison of Mean of Fraction of Clusters Owned",
	sub="Mean is calculated over the fraction of clusters owned of all runs for each timestep",
	xlab="Timestep",
	ylab="Fraction of Clusters Owned"
)
...
plot(
	...
	t='n',
	main="Comparison of Standard Deviation of Fraction of Clusters Owned",
	sub="Standard deviation is calculated over the fraction of clusters owned of all runs for each timestep",
	xlab="Timestep",
	ylab="Fraction of Clusters Owned"
